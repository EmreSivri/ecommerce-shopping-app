...
import com.ecommerce.shoppingapp.product.service.category.CategorySaveRequest;
    ...
    public void migrate() throws Exception {
        ...
        if (countOfData.equals(0L)) {
            ...
            IntStream.range(0, 20).forEach(item -> {
                ...
                byte[] file = null;
                try {
                    file = Files.readAllBytes(ResourceUtils.getFile("src/main/resources/product-images/phone.jpg").toPath());
                } catch (IOException e) {
